...
$(document).ready(function() {
    $('#myForm').submit(function(event) {
      ...
      if (firstname === '') {
        showError('firstNameError', 'Please fill in the firstname field');
        hasError = true;
      } else {
      ...
      if (lastname === '') {
        showError('lastNameError', 'Please fill in the lastname field');
        hasError = true;
      } else {
      ...
      if (!hasError) {
        $form.ajaxSubmit({
          success: function(response) {
            ...
            $('#formMessage').text('Account Created successfully!').show();
